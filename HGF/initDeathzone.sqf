...
if (isServer) then
{
	...
	_null = [{hint format["You have %1 minutes to reach the safe zone: %2", hg_deathZoneDelay/60, hg_safezonename]; hg_bordersActive = 0;},"BIS_fnc_spawn",true,true] spawn BIS_fnc_MP;
	/*_i = 0;
	{
	...
	_null = [{hint "Deathzone is active."; _null = [] execVM "HGF\deathzone.sqf";},"BIS_fnc_spawn",true,true] spawn BIS_fnc_MP;
};