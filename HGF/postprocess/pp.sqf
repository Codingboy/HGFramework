if (!isDedicated) then
{
	[0.33, 0.25, 0.015, 0.005, 1.5, 5, 1, 3, 0.5, 1.5] execVM "HGF\postprocess\tunnelview.sqf";
	[0.66, 0.15, 0.20, 0.05, 0.5, 1.5, 0.5, 1.5, 0.5, 1.5] execVM "HGF\postprocess\illusions.sqf";
