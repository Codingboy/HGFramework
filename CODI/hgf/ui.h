...
class RscTitles
{
	...
	class CODI_hgf_hudDayZ
	{
		idd = 55516;
		fadeout=0;
		fadein=0;
		duration = 86400;//24h
		name = "CODI_hgf_hudDayZ";
		onLoad = "uiNamespace setVariable ['CODI_hgf_hudDayZ', _this select 0]";
		class controlsBackground
		{
			class CODI_hgf_thirst_image_inner : RscPicture
			{
				idc = 55517;
				text = "CODI\hgf\media\hud\status_thirst_inside_4_ca.paa";
				x = 1.48;
				y = 1.3;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_thirst_image_outer : RscPicture
			{
				idc = 55518;
				text = "CODI\hgf\media\hud\status_thirst_border_CA.paa";
				x = 1.48;
				y = 1.3;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_hunger_image_inner : RscPicture
			{
				idc = 55519;
				text = "CODI\hgf\media\hud\status_food_inside_4_ca.paa";
				x = 1.48;
				y = 1.15;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_hunger_image_outer : RscPicture
			{
				idc = 55520;
				text = "CODI\hgf\media\hud\status_food_border_CA.paa";
				x = 1.48;
				y = 1.15;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_temperature_image_inner : RscPicture
			{
				idc = 55521;
				text = "CODI\hgf\media\hud\status_temp_2_ca.paa";
				x = 1.48;
				y = 1.0;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_temperature_image_outer : RscPicture
			{
				idc = 55522;
				text = "CODI\hgf\media\hud\status_temp_outside_ca.paa";
				x = 1.48;
				y = 1.0;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_health_image_inner : RscPicture
			{
				idc = 55523;
				text = "CODI\hgf\media\hud\status_blood_inside_6_ca.paa";
				x = 1.48;
				y = 0.85;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_health_image_outer : RscPicture
			{
				idc = 55524;
				text = "CODI\hgf\media\hud\status_blood_border_CA.paa";
				x = 1.48;
				y = 0.85;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_fatigue_image_inner : RscPicture
			{
				idc = 55525;
				text = "CODI\hgf\media\hud\sleep.paa";
				x = 1.48;
				y = 0.7;
				w = 0.10;
				h = 0.10;
			};
			class CODI_hgf_bleeding_image : RscPicture
			{
				idc = 55526;
				text = "CODI\hgf\media\hud\status_bleeding_ca.paa";
				x = 1.48;
				y = 0.85;
				w = 0.10;
				h = 0.10;
	...
	class CODI_hgf_hud
	{
		...
		duration = 86400;//24h
		name = "CODI_hgf_hud";
		onLoad = "uiNamespace setVariable ['CODI_hgf_hud', _this select 0]";

		class controlsBackground
		{
			class CODI_hgf_thirst_key : RscText
			{
				idc = -1;
				text = "$STR_CUT_THIRST";
				x = 1.3975;
			...
			class CODI_hgf_thirst_value : RscText
			{
				idc = 55511;
				text = "?";
				x = 1.5175;
			...
			class CODI_hgf_hunger_key : RscText
			{
				idc = -1;
				text = "Hunger:";
				x = 1.3975;
			...
			class CODI_hgf_hunger_value : RscText
			{
				idc = 55512;
				text = "?";
				x = 1.5175;
			...
			class CODI_hgf_fatigue_key : RscText
			{
				idc = -1;
				text = "Fatigue:";
				x = 1.3975;
			...
			class CODI_hgf_fatigue_value : RscText
			{
				idc = 55513;
				text = "?";
				x = 1.5175;
			...
			class CODI_hgf_health_key : RscText
			{
				idc = -1;
				text = "Damage:";
				x = 1.3975;
			...
			class CODI_hgf_health_value : RscText
			{
				idc = 55514;
				text = "?";
				x = 1.5175;
			...
			class CODI_hgf_temperature_key : RscText
			{
				idc = -1;
				text = "Temperature:";
				x = 1.3975;
			...
			class CODI_hgf_temperature_value : RscText
			{
				idc = 55515;
				text = "?";
				x = 1.5175;
