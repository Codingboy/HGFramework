...
hg_loot_special = ["B_Mortar_01_weapon_F","B_Mortar_01_support_F","B_UavTerminal","B_UAV_01_backpack_F", "Medikit", "U_B_Wetsuit", "V_RebreatherB", "U_B_GhillieSuit", "V_PlateCarrier2_rgr", "MineDetector", "NVGoggles", "Rangefinder", "H_HelmetB", "Binocular", "B_Kitbag_mcamo", "ToolKit"];
