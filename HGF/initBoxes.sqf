...
if (isServer) then
{
	...
	_inits = ["HGF\weaponBox.sqf", "HGF\ammoBox.sqf", "HGF\grenadeBox.sqf", "HGF\specialBox.sqf", "HGF\explosivesBox.sqf", "HGF\supportBox.sqf", "HGF\waterBox.sqf", "HGF\foodBox.sqf"];
	_crateMarkers = [];
	{
